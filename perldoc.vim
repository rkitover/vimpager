" Name:       perldoc.vim
" Maintainer: trapd00r
" Location:   http://trapd00r.se/configs/perldoc.vim     

" This is the standard perl.vim syntax file modified to work with vim as a
" pager, paging perldoc. "'" and '"' are removed, so are some cases with <<
